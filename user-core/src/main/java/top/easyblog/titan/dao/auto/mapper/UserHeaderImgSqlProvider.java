...
public class UserHeaderImgSqlProvider {
    ...
    public String countByExample(UserHeaderImgExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("user_header_img");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(UserHeaderImgExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("user_header_img");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String selectByExample(UserHeaderImgExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        UserHeaderImg record = (UserHeaderImg) parameter.get("record");
        UserHeaderImgExample example = (UserHeaderImgExample) parameter.get("example");
    ...
    protected void applyWhere(SQL sql, UserHeaderImgExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
